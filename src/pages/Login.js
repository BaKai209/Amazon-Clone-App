...
import { ButtonFacebook, ButtonGoogle, LinkRedirect } from '../styles/StyledComponents';
import { loginGoogle, loginWithEmailPassAsync } from '../redux/actions/actionIngreso';
    ...
    <div className={classes.root}>
        ...
        <div className={classes.login__container}>
            ...
            <ButtonGoogle 
                ...
                onClick={handleGoogle}
                >
                    <img width='20px' height='20px' src='https://www.academiaaudioplace.com/wp-content/uploads/2017/10/facebook-icon-preview-200x200.png' alt='Facebook Icon'/>
